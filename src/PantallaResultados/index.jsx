...
function PantallaResultados() {
  const { nombreJugador, Jugar, puntos, Reiniciar, ModalCambioNombre, totalNulos, negros, total, totalPositivos } = React.useContext(JuegoContext)
  ...
  return (
    <div className="pantalla-fondo pantalla-fondo--resultados">
    <div className="results-card">
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card bonus-balloons">
          <span className="stat-num">{totalNulos}</span>
          <span className="stat-title">Globos de Valor 0</span>
        </div>
      </div>
